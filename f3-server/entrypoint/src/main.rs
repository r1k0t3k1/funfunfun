...
use adapter_out_persistence::repository::agent_repository_impl::{self, AgentRepositoryImpl};
...
async fn main() -> std::io::Result<()> {
    ...
    let listener_repository_impl = Arc::new(ListenerRepositoryImpl::new(connection));
    let agent_repository_impl = Arc::new(AgentRepositoryImpl::new(connection));
    ...
    let c2_manager_handle = C2ManagerHandle::new(listener_repository_impl, agent_repository_impl);
